...
#We define initial values for the several parameters of a stereo algorithm
minDisparity = 16
...
#We create now an instance of the cv2.StereoSGBM class (semiglobal block matching) which is an algorithm used for computing disparity maps.
...
cv2.createTrackbar("uniquenessRation", "Disparity", uniquenessRatio, 50, update)
